...
pub mod pull {
    ...
    pub struct Platform {
        ...
        /// Output additional information provided by the server as part of the connection handshake.
        #[clap(long, short = 'H')]
        pub handshake_info: bool,

        /// Only allow fast-forward merges. Fail if the merge requires a merge commit.
        #[clap(long, conflicts_with = "no_ff")]
        pub ff_only: bool,

        /// Always create a merge commit, even when fast-forward is possible.
        #[clap(long, conflicts_with = "ff_only")]
        pub no_ff: bool,

        #[clap(flatten)]
        pub shallow: ShallowOptions,

        /// The name of the remote to pull from, or the url of the remote to connect to directly.
        ///
        /// If unset, the current branch will determine the remote.
        #[clap(long, short = 'r')]
        pub remote: Option<String>,
